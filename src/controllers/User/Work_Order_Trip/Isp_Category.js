...
export const createCategory = async (req, res) => {
  try {
    ...
    if (io) {
      io.emit("inspectionCategoryCreated", category);
    }
...
export const updateCategory = async (req, res) => {
  try {
    ...
    const io = req.app.get("io");
    if (io) {
      io.emit("inspectionCategoryUpdated", category);
    }
...
export const deleteCategory = async (req, res) => {
  try {
    ...
    const io = req.app.get("io");
    if (io) {
      io.emit("inspectionCategoryDeleted", { _id: id });
    }
...
export const changeCategoryStatus = async (req, res) => {
  try {
    ...
    const io = req.app.get("io");
    if (io) {
      io.emit("inspectionCategoryStatusChanged", category);
    }
